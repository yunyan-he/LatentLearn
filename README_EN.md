...
The README explains what LatentLearn is, how it works, and how to run it. The case study is a companion product story for portfolio and interview readers: it focuses on the problem framing, product decisions, AI PM tradeoffs, metrics, and reflection behind the implementation.
